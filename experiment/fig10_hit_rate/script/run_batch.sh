#!/bin/bash
#
# Batch Runner for Row Buffer Hit Rate Experiment (Figure 10)
#
...
#   config_name: DRAM, Conv, or SMART (default: DRAM)
...
# System config (same for all)
SYSTEM_INI="${EXPERIMENT_DIR}/system_hit.ini"
...
print_header() {
    ...
    local device_ini="$2"
    echo "============================================"
    echo " Row Buffer Hit Rate Experiment (Fig 10)"
    echo "============================================"
